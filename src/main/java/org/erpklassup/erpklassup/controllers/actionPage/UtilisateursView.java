...
public class UtilisateursView implements Initializable, VueDisposable {
    ...
    /**
     * ✅ CORRIGÉ : Le nombre de connectés est désormais calculé via la table
     * SessionUtilisateur (source fiable) au lieu de se baser sur derniereConnexion.
     */
    private void mettreAJourStatistiques(List<UtilisateurLigne> listeUtilisateurs, long totalElements) {
        ...
        // ✅ Comptage réel des utilisateurs connectés via SessionUtilisateur
